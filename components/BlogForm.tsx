...
type Variants = "Kegiatan" | "Pembelajaran";
  ...
  return (
    <form
      onSubmit={handleSubmit(
        variant === "Kegiatan" ? onSubmitBlog : onSubmitProject
      )}
    >
      <div>
        ...
        <Input
          ...
          placeholder="Title"
          className={`mt-2 ${errors.title ? "bg-red-100 border-red-500" : ""
            }`}
        />
        {errors.title && (
      ...
      <div className="mt-5">
        ...
        <Textarea
          ...
          className={`mt-2 ${errors.description ? "bg-red-100 border-red-500" : ""
            }`}
        />
        {errors.description && (
          <span className="text-sm mt-1 text-red-500">
